test_on_normal_small_data <- function(nsim = 1000)
{
    # Sample size
...
test_on_normal_moderate_data <- function(nsim = 1000)
{
    # Sample size
...
# system.time(out <- test_on_normal_moderate_data())

# Conclusion:
# 1. Bartlett test is the most robust test for normally distributed data.
# 2. Non of the tests can handle small sample size data nicely.
